...
def insert_project_image(image_path:str, project_id:int):
    ...
    insert_result = sql_excu(sql_insert_project_image)
...
def update_project_image(image_path:str, project_id:int):
    ...
    update_result = sql_excu(sql_update_project_image)
...
def delete_project_image(project_id:int):
    ...
    delete_result = sql_excu(sql_delete_project_image)
...
if __name__ == '__main__':
    ...
    # insert_project_image('./data/1.png', 1)
    query_project_image(1)
